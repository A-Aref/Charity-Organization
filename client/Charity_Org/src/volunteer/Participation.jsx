...
.then((data)=>{
  setParticipations(JSON.parse(data))
    ...
    const [populatedP,setPopulatedP] = useState(false)
    ...
    <div id='ParticipationsPage'>
        ...
        <div id='addbenef'>
            <button type="button" onClick={() => setPopUpP(true)} disabled={popUpP}>Record Participation</button>
        </div>
        {
        popUpP &&
        <div id='popUpB'>
            ...
            <div>
                <div>
                    ...
                    <input type="text" id="Participation_Type" value={ptype} onChange={(e) => setptype(e.target.value)}/>
                </div>
                <div>
            ...
            <div>
                ...
                <button type="button" onClick={addParticipation}>Save</button>
            </div>
        </div>
        }
    </div>
